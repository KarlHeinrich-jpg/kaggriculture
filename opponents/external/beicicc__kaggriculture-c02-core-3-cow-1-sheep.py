...
"""Kaggriculture C02 policy with a three-cow, one-sheep core herd.

The only strategic change from the reproduced public baseline is the initial
livestock allocation. It preserves the existing scenario-aware expansion and
routing logic while shifting one core slot from sheep to cow.
"""
